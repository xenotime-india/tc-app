...
const NAV_BAR_HEIGHT = Platform.OS === 'ios' ? (IS_IPHONE_X ? 88 : 64) : 100;
  ...
  renderHeaderTitle() {
    ...
    return (
      <Animated.View
        ...
        {typeof title === 'string' && (
          <Text numberOfLines={1} style={[styles.headerText, titleStyle]}>
            {title}
          </Text>
        )}
        {typeof title !== 'string' && title}
        {typeof subtitle === 'string' && (
          <Text numberOfLines={1} style={[styles.subHeaderText, subtitleStyle]}>
            {subtitle}
          </Text>
        )}
